...
export const members: Membership[] = [
  {
    ...
    github: "NONE",
    proficiency: { frontEnd: "X", backEnd: "X", design: "X", versionControl: "X", devOps: "X" },
...

  {
    ...
    proficiency: { frontEnd: "X", backEnd: 2, design: 4, versionControl: 5, devOps: 5 },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "Treasurer",
...

  {
    ...
    github: "brucewayne59",
    proficiency: { frontEnd: 3, backEnd: "X", design: "X", versionControl: 5, devOps: 5 },
...

  {
    ...
    github: "dianaprince",
    proficiency: { frontEnd: "X", backEnd: "X", design: "X", versionControl: 4, devOps: "X" },
...

  {
    ...
    github: "walterwhite",
    proficiency: { frontEnd: 4, backEnd: 5, design: 2, versionControl: "X", devOps: 3 },
...

  {
    ...
    github: "jonsnow",
    proficiency: { frontEnd: 2, backEnd: "X", design: 5, versionControl: "X", devOps: 4 },
    availability: { kind: "atLeast", min: 30, status: "ACTIVE" },
    role: "M",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: "X", backEnd: 3, design: "X", versionControl: 5, devOps: "X" },
    availability: { kind: "hoursUnknown", status: "ACTIVE" },
    role: "PL",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 3, backEnd: 1, design: 4, versionControl: 2, devOps: "X" },
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: "X", backEnd: 5, design: 2, versionControl: "X", devOps: 2 },
    availability: { kind: "range", min: 6, max: 10, status: "ACTIVE" },
    role: "Secretary",
...

  {
    ...
    github: "tifalockhart",
    proficiency: { frontEnd: 2, backEnd: "X", design: 1, versionControl: 3, devOps: 3 },
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 3, backEnd: "X", design: 2, versionControl: 3, devOps: "X" },
    availability: { kind: "hoursUnknown", status: "ACTIVE" },
    role: "Developer",
...

  {
    ...
    github: "alyxvance8",
    proficiency: { frontEnd: "X", backEnd: 5, design: 3, versionControl: "X", devOps: 4 },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "PL",
    currentRoles: [
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 1, backEnd: "X", design: 2, versionControl: 5, devOps: 2 },
...

  {
    ...
    github: "arthurmorgan",
    proficiency: { frontEnd: 3, backEnd: "X", design: "X", versionControl: 3, devOps: 5 },
    availability: { kind: "hoursUnknown", status: "ACTIVE" },
    role: "Analyst",
...

  {
    ...
    github: "johnmarston",
    proficiency: { frontEnd: 1, backEnd: "X", design: 5, versionControl: 3, devOps: 4 },
    availability: { kind: "atLeast", min: 25, status: "ACTIVE" },
    role: "Secretary",
...

  {
    ...
    github: "jodieholmes",
    proficiency: { frontEnd: "X", backEnd: "X", design: "X", versionControl: 3, devOps: "X" },
...

  {
    ...
    github: "martymcfly67",
    proficiency: { frontEnd: "X", backEnd: 4, design: 4, versionControl: "X", devOps: 2 },
    availability: { kind: "range", min: 16, max: 20, status: "ACTIVE" },
    role: "Analyst",
...

  {
    ...
    proficiency: { frontEnd: 4, backEnd: 2, design: "X", versionControl: 5, devOps: 2 },
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 3, backEnd: "X", design: "X", versionControl: 5, devOps: 1 },
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 1, backEnd: 2, design: "X", versionControl: 5, devOps: 5 },
    availability: { kind: "hoursUnknown", status: "ACTIVE" },
    role: "External VP",
...

  {
    ...
    github: "mariecurie",
    proficiency: { frontEnd: "X", backEnd: 5, design: 5, versionControl: "X", devOps: 2 },
    availability: { kind: "atLeast", min: 30, status: "ACTIVE" },
    role: "PL",
...

  {
    ...
    github: "nikolatesla",
    proficiency: { frontEnd: "X", backEnd: "X", design: 5, versionControl: "X", devOps: 5 },
...

  {
    ...
    github: "isaacnewton",
    proficiency: { frontEnd: "X", backEnd: 2, design: 3, versionControl: 1, devOps: 5 },
    availability: { kind: "range", min: 6, max: 10, status: "ACTIVE" },
    role: "Analyst",
    currentRoles: [
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 1, backEnd: "X", design: 5, versionControl: 4, devOps: 1 },
    availability: { kind: "range", min: 11, max: 15, status: "ACTIVE" },
    role: "Head",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 5, backEnd: "X", design: 1, versionControl: 4, devOps: 4 },
    availability: { kind: "hoursUnknown", status: "ACTIVE" },
    role: "Developer",
    currentRoles: [
...

  {
    ...
    proficiency: { frontEnd: 2, backEnd: 5, design: 2, versionControl: 5, devOps: "X" },
    availability: { kind: "range", min: 6, max: 10, status: "BREAK" },
    role: "Secretary",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 1, backEnd: 1, design: "X", versionControl: 5, devOps: "X" },
    availability: { kind: "range", min: 16, max: 20, status: "ACTIVE" },
    role: "H",
...

  {
    ...
    github: "vintcerf",
    proficiency: { frontEnd: 5, backEnd: 3, design: "X", versionControl: "X", devOps: 1 },
    availability: { kind: "range", min: 11, max: 15, status: "ACTIVE" },
    role: "Head",
...

  {
    ...
    github: "bobkahn",
    proficiency: { frontEnd: "X", backEnd: "X", design: 4, versionControl: 5, devOps: "X" },
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 5, backEnd: "X", design: "X", versionControl: "X", devOps: 5 },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "M",
...

  {
    ...
    proficiency: { frontEnd: "X", backEnd: 4, design: 3, versionControl: 5, devOps: 2 },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "Analyst",
...

  {
    ...
    proficiency: { frontEnd: "X", backEnd: 3, design: 3, versionControl: 5, devOps: 2 },
    availability: { kind: "atLeast", min: 20, status: "UNKNOWN" },
    role: "Developer",
...

  {
    ...
    proficiency: { frontEnd: 3, backEnd: "X", design: "X", versionControl: 1, devOps: 1 },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "Internal VP",
...

  {
    ...
    proficiency: { frontEnd: 5, backEnd: "X", design: 3, versionControl: 3, devOps: "X" },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "Project Manager",
...

  {
    ...
    github: "kobebryant",
    proficiency: { frontEnd: "X", backEnd: "X", design: 1, versionControl: "X", devOps: 5 },
    availability: { kind: "range", min: 1, max: 5, status: "INACTIVE" },
    role: "Developer",
...

  {
    ...
    proficiency: { frontEnd: 5, backEnd: "X", design: 2, versionControl: "X", devOps: 5 },
    availability: { kind: "range", min: 11, max: 15, status: "ACTIVE" },
    role: "Jr. Developer",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 1, backEnd: 2, design: "X", versionControl: "X", devOps: 1 },
    availability: { kind: "atLeast", min: 25, status: "ACTIVE" },
    role: "Developer",
...

  {
    ...
    proficiency: { frontEnd: 4, backEnd: "X", design: 5, versionControl: 2, devOps: 2 },
    availability: { kind: "atLeast", min: 20, status: "ACTIVE" },
    role: "Sr. Developer",
    currentRoles: [
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: "X", backEnd: 4, design: 2, versionControl: 1, devOps: "X" },
    availability: { kind: "range", min: 11, max: 15, status: "ACTIVE" },
    role: "Sr. Developer",
...

  {
    ...
    github: "chrispaul",
    proficiency: { frontEnd: 4, backEnd: 2, design: "X", versionControl: 1, devOps: "X" },
...

  {
    ...
    github: "kawhileonard",
    proficiency: { frontEnd: "X", backEnd: 2, design: 1, versionControl: "X", devOps: 3 },
    availability: { kind: "hoursUnknown", status: "ACTIVE" },
    role: "Analyst",
    currentRoles: [
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 5, backEnd: 2, design: 2, versionControl: 1, devOps: "X" },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "Developer",
...

  {
    ...
    proficiency: { frontEnd: 4, backEnd: 3, design: "X", versionControl: 2, devOps: 2 },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "Designer",
...

  {
    ...
    github: "kofiilic",
    proficiency: { frontEnd: "X", backEnd: "X", design: 1, versionControl: 3, devOps: "X" },
    availability: { kind: "atLeast", min: 30, status: "ACTIVE" },
    role: "Project Manager",
...

  {
    ...
    github: "freyakahale",
    proficiency: { frontEnd: "X", backEnd: 5, design: "X", versionControl: 2, devOps: "X" },
...

  {
    ...
    github: "oscarkarim",
    proficiency: { frontEnd: "X", backEnd: 3, design: 4, versionControl: 1, devOps: 3 },
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: "X", backEnd: 3, design: 3, versionControl: "X", devOps: "X" },
    availability: { kind: "atLeast", min: 20, status: "ACTIVE" },
    role: "Designer",
...

  {
    ...
    proficiency: { frontEnd: "X", backEnd: 2, design: 2, versionControl: 3, devOps: "X" },
    availability: { kind: "range", min: 6, max: 10, status: "ACTIVE" },
    role: "Analyst",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: "X", backEnd: 1, design: 5, versionControl: 4, devOps: 5 },
    availability: { kind: "atLeast", min: 15, status: "ACTIVE" },
    role: "External VP",
...

  {
    ...
    github: "chiarakahale",
    proficiency: { frontEnd: 2, backEnd: "X", design: "X", versionControl: "X", devOps: "X" },
    availability: { kind: "lessThan", max: 2, status: "ACTIVE" },
    role: "Analyst",
...

  {
    ...
    github: "noorrojas",
    proficiency: { frontEnd: 2, backEnd: 4, design: 3, versionControl: "X", devOps: 1 },
    availability: { kind: "range", min: 6, max: 10, status: "ACTIVE" },
    role: "M",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 4, backEnd: "X", design: "X", versionControl: 3, devOps: "X" },
    availability: { kind: "range", min: 11, max: 15, status: "ACTIVE" },
    role: "Analyst",
    currentRoles: [
...

  {
    ...
    proficiency: { frontEnd: "X", backEnd: 4, design: 2, versionControl: "X", devOps: 2 },
    availability: { kind: "range", min: 1, max: 5, status: "ACTIVE" },
    role: "H",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: 3, backEnd: 2, design: "X", versionControl: "X", devOps: "X" },
    availability: { kind: "atLeast", min: 20, status: "ACTIVE" },
    role: "Secretary",
    currentRoles: [
...

  {
    ...
    proficiency: { frontEnd: 1, backEnd: 5, design: 1, versionControl: "X", devOps: 3 },
    availability: { kind: "hoursUnknown", status: "ACTIVE" },
    role: "Jr. Analyst",
    currentRoles: [
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: "X", backEnd: 1, design: 5, versionControl: "X", devOps: 2 },
    availability: { kind: "range", min: 11, max: 15, status: "ACTIVE" },
    role: "Advisor",
...

  {
    ...
    github: "NONE",
    proficiency: { frontEnd: "X", backEnd: 4, design: "X", versionControl: "X", devOps: "X" },
    availability: { kind: "hoursUnknown", status: "INACTIVE" },
    role: "Secretary",
...

  {
    ...
    github: "kofikelly",
    proficiency: { frontEnd: "X", backEnd: 2, design: "X", versionControl: "X", devOps: "X" },
    availability: { kind: "atLeast", min: 20, status: "ACTIVE" },
    role: "Treasurer",
